...
if (!empty($search)) {
    $base_query .= " AND (
        ...
        o.medicaments LIKE :search OR
        o.posologie LIKE :search OR
        o.duree_traitement LIKE :search OR
...
$data_query = "
    SELECT 
        ...
        COALESCE(o.medicaments, '') AS medicaments,
        COALESCE(o.posologie, '') AS posologie,
        COALESCE(o.duree_traitement, '') AS duree_traitement,
