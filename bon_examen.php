...
<div class="card mt-4">
  ...
  <?php endif; ?>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="service_demandeur" class="form-control" placeholder="Ex: Médecine interne" required>
      </div>

      <div class="mb-3">
        <label class="form-label fw-semibold">Renseignement clinique</label>
